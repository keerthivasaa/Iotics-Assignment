        ...
        fontSize: 16}}>Living Room</Text>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity onPress={onSwitchPress4} >
                        {lightFour ?
                            <View style={{ alignItems: 'center', }}>
                                <MaterialCommunityIcons name="power-plug-outline" size={64} color={'white'} style={{}} />
                                <Text style={{ color: 'white', marginTop: 15 }}>Fan</Text>
                            </View> :
                            <View style={{ alignItems: 'center', }}>
                                <MaterialCommunityIcons name="power-plug-outline" size={64} color={'gray'} style={{}} />
                                <Text style={{ color: 'white', marginTop: 15 }}>Fan</Text>
                            </View>
                        }
                    </TouchableOpacity>
